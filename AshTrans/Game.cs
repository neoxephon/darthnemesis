...
namespace AshTrans
{
    ...
    public class Game : AbstractGame
    {
        ...
        {
            this.Files.TextFiles.Add(new NidxFile(@"help\item_name", this));
            this.Files.TextFiles.Add(new NidxFile(@"help\item_name_unknown", this));
            this.Files.TextFiles.Add(new NidxFile(@"help\skill_category_help", this));
            this.Files.TextFiles.Add(new NidxFile(@"help\skill_name", this));
            this.Files.TextFiles.Add(new NidxFile(@"help\skill_variety_help", this));
        }
